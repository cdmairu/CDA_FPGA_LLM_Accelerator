...
2. `cd host`
3. `py fpga_host.py --port COM3 --N 4 --baud 115200 --iters 100 --fclk 100000000 --timeout 5`

### Matrix Dimension of 8

1. make sure `parameter integer N = 8` in `rtl/top.v` and re-program the board
2. `cd host`
3. `py fpga_host.py --port COM3 --N 8 --baud 115200 --iters 100 --fclk 100000000 --timeout 5`
